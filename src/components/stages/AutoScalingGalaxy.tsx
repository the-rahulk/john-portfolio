...
export default function AutoScalingGalaxy() {
  ...
  return (
    <section id="scale" className="w-full min-h-screen py-24 bg-[#f5f5f7] text-[#1d1d1f] flex items-center justify-center border-b border-[#e0e0e0]">
      <div className="max-w-6xl w-full px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div>
              ...
              <div className="mb-8">
                <div className="flex justify-between font-mono text-xs text-gray-500 mb-2">
                  ...
                  <span className="font-bold text-[#0066cc]">{load} Req/sec</span>
                </div>
                <input 
                  type="range" 
                  min="100" 
                  ...
                  className="w-full h-2 bg-[#f0f0f0] rounded-lg appearance-none cursor-pointer accent-[#0066cc]"
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-[#f5f5f7]">
                  <div className="text-[10px] font-mono text-gray-500 mb-1">AVG CPU LOAD</div>
                  <div className="text-2xl font-mono font-bold text-[#1d1d1f]">
                    {cpuLoad}%
                  </div>
                </div>
                <div className="p-4 rounded-lg bg-[#f5f5f7]">
                  <div className="text-[10px] font-mono text-gray-500 mb-1">ACTIVE PODS</div>
                  <div className="text-2xl font-mono font-bold text-[#ff7a4c] flex items-center gap-1.5">
                    <span>{podsCount}</span>
                    <span className="text-xs text-gray-400 font-sans">Pods</span>
                  </div>
                </div>
              </div>
            </div>

            <div className="mt-8 pt-4 border-t border-[#f0f0f0] text-[11px] text-gray-400 font-mono flex items-center gap-2">
          ...
          {/* Pod Visualizer Grid */}
          <div className="lg:col-span-7 bg-white border border-[#e0e0e0] rounded-lg p-6 flex flex-col justify-between hover:shadow-lg transition-all border-glow">
            <div className="flex items-center justify-between border-b border-[#f0f0f0] pb-4 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[12px] font-bold text-gray-500 uppercase tracking-wider">Kubernetes Pod Instances</span>
              </div>
              <span className="text-xs font-mono text-[#0066cc] bg-[#0066cc]/5 px-2 py-0.5 rounded">
                  ...
                  <div 
                    ...
                    className={`p-4 rounded-lg border flex flex-col items-center justify-center transition-all ${
                      isActive 
                        ...
                        : "border-[#e0e0e0] opacity-25 text-gray-300 bg-gray-50"
                    }`}
                  >
                    <div className="relative flex h-2.5 w-2.5 mb-2">
                      ...
                      <span className={`relative inline-flex rounded-full h-2.5 w-2.5 ${isActive ? "bg-emerald-500" : "bg-gray-400"}`}></span>
                    </div>
            ...
            {load > 5000 && (
              <div className="mt-6 flex items-center justify-center gap-1.5 text-xs font-mono text-amber-500 bg-amber-50 border border-amber-200 p-2.5 rounded-lg">
